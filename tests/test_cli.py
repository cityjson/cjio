...
class TestCLI:
    def test_crs_assign_cli(self, delft_path, data_output_dir):
        ...
        result = runner.invoke(
            cjio.cli, args=[delft_path, "crs_assign", "4326", "save", p_out]
        )
    ...
    def test_vertices_clean_cli(self, delft_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(
            cjio.cli, args=[delft_path, "vertices_clean", "save", p_out]
        )
    ...
    def test_export_obj_cli(self, delft_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "export", "obj", p_out])
    ...
    def test_metadata_get_cli(self, delft_path):
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "metadata_get"])

        assert result.exit_code == 0

    def test_info_cli(self, delft_path):
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "info"])
        print(f"CLI returned '{result.output}'")
        assert result.exit_code == 0
    ...
    def test_merge_cli(self, delft_path, rotterdam_subset_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(
            cjio.cli, args=[delft_path, "merge", rotterdam_subset_path, "save", p_out]
        )
    ...
    def test_attribute_remove_cli(self, delft_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(
            cjio.cli, args=[delft_path, "attribute_remove", "bgt_status", "save", p_out]
        )
    ...
    def test_attribute_rename_cli(self, delft_path, data_output_dir):
        ...
        result = runner.invoke(
            cjio.cli,
            args=[delft_path, "attribute_rename", "hoek", "angle", "save", p_out],
        )
    ...
    def test_save_cli(self, delft_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "save", "--indent", p_out])
    ...
    def test_upgrade_cli(self, delft_path, data_output_dir):
        ...
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "upgrade", "save", p_out])
    ...
    def test_validate_cli(self, delft_path):
        ...
        runner = CliRunner()
        result = runner.invoke(cjio.cli, args=[delft_path, "validate"])
